...
function showEdges(dot) {
    if (dot === dot1) {
        ...
        createEdge(dot2.position, new THREE.Vector3(8, 7, 0), 'r', 2, '../images/xyz.jpg', 'https://nerf-hp01.vkist-hub.com/');
    }
}

dot1 = createCustomDot(-4, 1, 1);
dot2 = createCustomDot(6.5, 1, -0.4);
